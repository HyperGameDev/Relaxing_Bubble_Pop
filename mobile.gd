...
@onready var control_mobile_left: Control = %Control_Left
...
@onready var button_mobile_left: TouchScreenButton = %Touch_Left
...
func _ready():
	...
	#button_mobile_left.released.connect(on_mobile_left_released)
...
func on_mobile_menu_released():
	control_mobile_dark.visible = !control_mobile_dark.visible
	control_mobile_left.visible = !control_mobile_left.visible
	control_mobile_count.visible = !control_mobile_count.visible
	control_mobile_pause.visible = !control_mobile_pause.visible
